...
describe('قانون التخطيط على كل الشاشات', () => {
  ...
  it('لا استعلام وسائط يغيّر مقاسًا، إنما ترتيبًا أو فراغًا', () => {
    ...
    // بعرضٍ مقرَّر بجانب النموذج، وتحت ‎900px‎ تنزل تحته صفًّا يمتدّ عرضَه كلّه.
    // فالمحور تبدّل، والقيدُ الأفقي لم يبقَ له معنى: منعُ رفعه يعني إمّا لوحةً
    // بعرض ‎96px‎ معلّقةً في أسفل شاشةٍ عريضة، أو رقمًا ثانيًا يُكتب في الاستعلام —
    // وهذا هو المقاس المنهيّ عنه فعلًا.
    //
    // والحدّ ضيّق عمدًا: `auto` نصًّا لا `initial` ولا `revert` ولا `unset`،
